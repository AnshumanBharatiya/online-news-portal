...
if($query)
{
$msg="Coronavirus page successfully updated ";
}
else{
...
<html lang="en">
    <head>
       ...
       <link rel="shortcut icon" href="assets/images/mylogo.png" type="image/png">
            <!-- App title -->
        <title>Newsportal | Coronavirus Latest News on Coronavirus </title>
            <!-- Summernote css -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Coronavirus Page  </h4>
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="p-6">
                                    <div class="">
                                        <form name="coronavirus" method="post">
